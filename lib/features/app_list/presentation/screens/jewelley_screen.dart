          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                _buildCategoryTitle('Diamonds2', 3, context),
                _buildItemList(jewelleryRepository.diamon2()),
                _buildCategoryTitle('Diamonds3', 4, context),
                _buildItemList(jewelleryRepository.diamon3()),
                _buildCategoryTitle('Diamonds4', 5, context),
                _buildItemList(jewelleryRepository.diamon4()),
                _buildCategoryTitle('Diamonds5', 6, context),
                _buildItemList(jewelleryRepository.diamon5()),
                _buildCategoryTitle('Diamonds6', 7, context),
                _buildItemList(jewelleryRepository.diamon6()),
                _buildCategoryTitle('Diamonds7', 8, context),
                _buildItemList(jewelleryRepository.diamon7()),
                _buildCategoryTitle('Diamonds8', 9, context),
                _buildItemList(jewelleryRepository.diamon8()),
                _buildCategoryTitle('Diamonds9', 10, context),
                _buildItemList(jewelleryRepository.diamon9()),
                _buildCategoryTitle('Diamonds10', 11, context),
                _buildItemList(jewelleryRepository.diamon10()),
                _buildCategoryTitle('Diamonds11', 12, context),
                _buildItemList(jewelleryRepository.diamon11()),
                _buildCategoryTitle('Diamonds12', 13, context),
